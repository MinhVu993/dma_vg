...
<head>
    ...
    <title>New Dormitory Request</title>
    <style>
    table {
...
<body>
    <div class="header">
        <p>Dear Manager / 尊敬的經理,</p>
        <p>Có đơn mới cần xét duyệt / 有一個新申請，請登入系統審核:</p>
        <p><b>Department / 部門:</b> {{ $dept }}</p>
        <p><b>Number of Occupants / 住宿人數:</b> {{ $count }}</p>
    </div>
    ...
    <p>Please login to the system to review this request / 請登入系統審核此申請:</p>
    <a href="{{ $link }}" class="action-link">Open Application / 打開應用</a>
